...
urlpatterns = patterns(
    ...
    url(r'^(?P<post_id>\d+)/post_delete/$', views.post_delete, name='post_delete'),
    url(r'^(?P<forum_id>\d+)/$', views.topic_list, name='topic_list'),
    url(r'^vote/(?P<post_id>\d+)/$', views.vote_create, name='vote_create'),
    url(r'^pin/(?P<topic_id>\d+)/$', views.pin, name='pin'),
    url(r'^unpin/(?P<topic_id>\d+)/$', views.unpin, name='unpin'),
)
